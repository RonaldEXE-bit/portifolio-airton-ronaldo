...
export default function Curriculo() {
  return (
    <div className="content-overlay page-zoom-in relative">
      {/* Fundo de partículas */}
      <Particles quantity={250} size={2} color="#27c39f" staticity={50} ease={50} />

      <header className="mb-10 text-center relative z-10">
        <h1 className="text-4xl font-bold text-cyan-400">Currículo</h1>
        <p className="text-lg opacity-70">Resumo da minha trajetória profissional</p>
      </header>

      {/* Card principal do currículo */}
      <div className="curriculo-card relative z-10 max-w-4xl mx-auto">
        ...
        <div className="curriculo-section">
          ...
          <ul className="section-list">
            ...
            <li>Introdução à Cibersegurança – Cisco Networking Academy (2025)</li>
          </ul>
        </div>
            ...
            <li className="icon-content">
              ...
              <a href="https://instagram.com/" aria-label="Instagram" data-social="instagram">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                  ...
                  3.85.088 3.269.222 2.76.42a3.9 3.9 0 0 0-1.417.923A3.9 
                  3.9 0 0 0 .42 2.76C.222 3.268.087 
                  3.85.048 4.7.01 5.555 0 5.827 
                  0 8.001c0 2.172.01 2.444.048 
                  3.297.04.852.174 1.433.372 
                  1.942.205.526.478.972.923 
                  1.417.444.445.89.719 1.416.923.51.198 
                  1.09.333 1.942.372C5.555 15.99 
                  5.827 16 8 16s2.444-.01 
                  3.298-.048c.851-.04 1.434-.174 
                  ...
                  10.172 0 7.998 0zm-.717 1.442h.718c2.136 0 2.389.007 
                  3.232.046.78.035 1.204.166 1.486.275.373.145.64.319.92.599s.453.546.598.92c.11.281.24.705.275 
                  1.485.039.843.047 1.096.047 3.231s-.008 2.389-.047 
                  3.232c-.035.78-.166 1.203-.275 1.485a2.5 2.5 0 0 1-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.5 2.5 0 0 1-.92-.598 2.5 2.5 0 0 1-.6-.92c-.109-.281-.24-.705-.275-1.485-.038-.843-.046-1.096-.046-3.233s.008-2.388.046-3.231c.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92s.546-.453.92-.598c.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045zm4.988 
            ...
            <li className="icon-content">
              <a href="https://youtube.com/" aria-label="Youtube" data-social="youtube">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                  ...
                  1.42c.101.38.172.883.22 1.402l.01.104.022.26.008.104c.065.914.073 
                  1.77.074 1.957v.075c-.001.194-.01 1.108-.082 
                  2.06l-.008.105-.009.104c-.05.572-.124 
                  1.14-.235 1.558a2.01 2.01 0 0 1-1.415 
